...
exports.deleteUser = exports.rejectDestinationRequest = exports.approveDestinationRequest = exports.getDestinationRequests = exports.deleteDestination = exports.updateDestination = exports.createDestination = exports.getDestinations = exports.getActivityLogs = exports.resolveIncident = exports.getIncidents = exports.getBookings = exports.getHotels = exports.getGuides = exports.rejectHotel = exports.verifyHotel = exports.rejectGuide = exports.verifyGuide = exports.getPendingHotelVerifications = exports.getPendingGuideVerifications = exports.getUsers = exports.getAdminDashboard = void 0;
...
const mapDestination = (destination) => ({
    ...
    latitude: destination.latitude === null || destination.latitude === undefined
        ? null
        : Number(destination.latitude),
    longitude: destination.longitude === null || destination.longitude === undefined
        ? null
    ...
    pricePerDayNpr: destination.price_per_day_npr === null || destination.price_per_day_npr === undefined
        ? null
...
const getAdminDashboard = async (req, res) => {
    try {
        ...
        const tourists = await prisma_1.prisma.users.count({ where: { role: "tourist" } });
        const guides = await prisma_1.prisma.users.count({ where: { role: "guide" } });
        const hotels = await prisma_1.prisma.users.count({ where: { role: "hotel" } });
        // Get booking statistics
        const totalBookings = await prisma_1.prisma.booking.count();
        const pendingBookings = await prisma_1.prisma.booking.count({ where: { status: "pending" } });
        const confirmedBookings = await prisma_1.prisma.booking.count({ where: { status: "confirmed" } });
        const cancelledBookings = await prisma_1.prisma.booking.count({ where: { status: "cancelled" } });
        // Get verification statistics
        const pendingGuideVerifications = await prisma_1.prisma.guide.count({
            where: { verified_status: false },
        });
        const pendingHotelVerifications = await prisma_1.prisma.hotel.count({
            where: { verified_status: false },
        });
        const verifiedGuides = await prisma_1.prisma.guide.count({
            where: { verified_status: true },
        });
        const verifiedHotels = await prisma_1.prisma.hotel.count({
            where: { verified_status: true },
        });
        // Get incident/SOS statistics
        const activeIncidents = await prisma_1.prisma.incident_report.count({});
        const activeSOSReports = await prisma_1.prisma.sos_report.count({
            where: { status: "active" },
        });
        ...
        return (0, response_1.sendSuccess)(res, 200, "Admin dashboard retrieved", {
            overview: {
                totalUsers,
                usersByRole: {
                    tourists,
...
const getUsers = async (req, res) => {
    try {
        ...
        const total = await prisma_1.prisma.users.count({ where });
        return (0, response_1.sendSuccess)(res, 200, "Users retrieved", {
            users,
            pagination: {
                page: parseInt(page),
                limit: take,
        ...
        return (0, response_1.sendError)(res, 500, "Failed to get users");
    }
};
 ...
 */
const getPendingGuideVerifications = async (req, res) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Pending guides retrieved", {
            count: guides.length,
            guides: guides.map((g) => ({
                guideId: g.guide_id,
        ...
        return (0, response_1.sendError)(res, 500, "Failed to get pending guides");
    }
};
exports.getPendingGuideVerifications = getPendingGuideVerifications;
/**
 * GET /admin/hotels/pending-verification
 * Get hotels pending verification
 */
const getPendingHotelVerifications = async (req, res) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Pending hotels retrieved", {
            count: hotels.length,
        ...
        return (0, response_1.sendError)(res, 500, "Failed to get pending hotels");
    }
};
exports.getPendingHotelVerifications = getPendingHotelVerifications;
/**
...
const verifyGuide = async (req, res) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Guide verified successfully", {
        ...
        return (0, response_1.sendError)(res, 500, "Failed to verify guide");
    }
};
exports.verifyGuide = verifyGuide;
/**
...
const rejectGuide = async (req, res) => {
    try {
        ...
        return (0, response_1.sendError)(res, 500, "Failed to reject guide");
    }
};
exports.rejectGuide = rejectGuide;
/**
...
const verifyHotel = async (req, res) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Hotel verified successfully", {
            hotelId: parsedId,
            verifiedStatus: true,
        });
    }
        ...
        return (0, response_1.sendError)(res, 500, "Failed to verify hotel");
    }
};
...
const rejectHotel = async (req, res) => {
    try {
        ...
        return (0, response_1.sendError)(res, 500, "Failed to reject hotel");
    }
};
...
const getGuides = async (req, res) => {
    try {
        ...
        const [guides, total] = await Promise.all([
            prisma_1.prisma.guide.findMany({
                where,
                include: {
                    users: {
                        select: {
            ...
            prisma_1.prisma.guide.count({ where }),
        ]);
        return (0, response_1.sendSuccess)(res, 200, "Guides retrieved", {
        ...
        return (0, response_1.sendError)(res, 500, "Failed to get guides");
    }
};
...
const getHotels = async (req, res) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Hotels retrieved", {
            hotels: hotels.map((hotel) => ({
                hotelId: hotel.hotel_id,
                name: hotel.hotel_name,
                ownerName: hotel.users.full_name,
        ...
        return (0, response_1.sendError)(res, 500, "Failed to get hotels");
    }
};
...
const getIncidents = async (req, res) => {
    try {
        const incidents = await prisma_1.prisma.incident_report.findMany({
            include: {
        ...
        const sosReports = await prisma_1.prisma.sos_report.findMany({
            include: {
                tourist: { include: { users: { select: { full_name: true } } } },
            },
            orderBy: { timestamp: "desc" },
        });
        return (0, response_1.sendSuccess)(res, 200, "Incidents retrieved", {
            incidents: {
        ...
        return (0, response_1.sendError)(res, 500, "Failed to get incidents");
    }
};
...
const resolveIncident = async (req, res) => {
    try {
        ...
        const incident = await prisma_1.prisma.incident_report.findUnique({
            where: { incident_id: parseInt(incidentId) },
        });
        if (!incident) {
            return (0, response_1.sendError)(res, 404, "Incident not found");
        }
        // Log admin action
        await prisma_1.prisma.admin_action.create({
            data: {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Incident marked as resolved", {
            incidentId,
        ...
        return (0, response_1.sendError)(res, 500, "Failed to resolve incident");
    }
};
...
const getActivityLogs = async (req, res) => {
    try {
        const logs = await prisma_1.prisma.admin_action.findMany({
            include: {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Activity logs retrieved", {
            count: logs.length,
            logs: logs.map((l) => ({
                id: l.action_id,
                type: l.action_type,
        ...
        return (0, response_1.sendError)(res, 500, "Failed to get activity logs");
    }
};
...
const getDestinations = async (req, res) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Destinations retrieved", {
        ...
        return (0, response_1.sendError)(res, 500, "Failed to get destinations");
    }
};
...
const createDestination = async (req, res) => {
    try {
        ...
        const popularityScore = parseOptionalCoordinate(req.body.popularityScore ?? req.body.safetyRating);
        ...
        return (0, response_1.sendSuccess)(res, 201, "Destination created", {
            destination: mapDestination(destination),
        });
    }
    catch (error) {
        console.error("Error creating destination:", error);
        return (0, response_1.sendError)(res, 500, "Failed to create destination");
    }
};
...
const updateDestination = async (req, res) => {
    try {
        ...
        if (!Number.isInteger(destinationId) || destinationId <= 0) {
            return (0, response_1.sendError)(res, 400, "Invalid destination id");
        }
        const name = normalizeText(req.body.name);
        const location = normalizeText(req.body.location ?? req.body.address);
        const description = normalizeText(req.body.description) || null;
        ...
        const activities = parseStringList(req.body.activities);
        const highlights = parseStringList(req.body.highlights);
        const existing = await prisma_1.prisma.destination.findUnique({
            where: { destination_id: destinationId },
        });
        if (!existing) {
            return (0, response_1.sendError)(res, 404, "Destination not found");
        }
        const destination = await prisma_1.prisma.destination.update({
            where: { destination_id: destinationId },
            data: {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Destination updated", {
            destination: mapDestination(destination),
        });
    }
    catch (error) {
        console.error("Error updating destination:", error);
        return (0, response_1.sendError)(res, 500, "Failed to update destination");
    }
};
...
const deleteDestination = async (req, res) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Destination deleted", {
            destinationId,
        });
    }
    catch (error) {
        console.error("Error deleting destination:", error);
        return (0, response_1.sendError)(res, 500, "Failed to delete destination");
    }
};
...
const getDestinationRequests = async (req, res) => {
    try {
        const requests = await prisma_1.prisma.destination_request.findMany({
            include: {
                guide: {
                    include: {
                        users: {
        ...
        return (0, response_1.sendSuccess)(res, 200, "Destination requests retrieved", {
            ...
            requests: requests.map((request) => ({
                ...
                image: request.image,
                latitude: request.latitude === null || request.latitude === undefined
                    ? null
                    : Number(request.latitude),
                longitude: request.longitude === null || request.longitude === undefined
                    ? null
        ...
        return (0, response_1.sendError)(res, 500, "Failed to get destination requests");
    }
};
 ...
 */
const approveDestinationRequest = async (req, res) => {
    try {
        const requestId = Number.parseInt(req.params.id, 10);
        if (!Number.isInteger(requestId) || requestId <= 0) {
            return (0, response_1.sendError)(res, 400, "Invalid destination request id");
        }
        const request = await prisma_1.prisma.destination_request.findUnique({
            where: { request_id: requestId },
        });
        if (!request) {
            return (0, response_1.sendError)(res, 404, "Destination request not found");
        }
        if (request.status === "approved") {
            return (0, response_1.sendError)(res, 400, "Destination request already approved");
        }
        const destination = await prisma_1.prisma.destination.create({
            data: {
        ...
        await prisma_1.prisma.destination_request.update({
            where: { request_id: requestId },
            data: {
                status: "approved",
        ...
        return (0, response_1.sendSuccess)(res, 200, "Destination request approved", {
            requestId,
            destination: mapDestination(destination),
        });
    }
        ...
        return (0, response_1.sendError)(res, 500, "Failed to approve destination request");
    }
};
exports.approveDestinationRequest = approveDestinationRequest;
/**
 * PATCH /admin/destination-requests/:id/reject
 * Reject a destination request
 */
const rejectDestinationRequest = async (req, res) => {
    try {
        const requestId = Number.parseInt(req.params.id, 10);
        ...
        return (0, response_1.sendSuccess)(res, 200, "Destination request rejected", {
            requestId,
            reason,
        });
    }
        ...
        return (0, response_1.sendError)(res, 500, "Failed to reject destination request");
    }
};
exports.rejectDestinationRequest = rejectDestinationRequest;
/**
...
const deleteUser = async (req, res) => {
    try {
        ...
        return (0, response_1.sendError)(res, 500, "Failed to delete user");
    }
};
